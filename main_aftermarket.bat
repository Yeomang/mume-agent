...
set /a _W=0
:_wait_agent_aftermarket
netstat -ano 2>nul | findstr ":9000.*LISTENING" >nul 2>&1
if %errorlevel% equ 0 goto _agent_ready_aftermarket
set /a _W+=1
if %_W% geq 12 goto _agent_ready_aftermarket
timeout /t 5 /nobreak >nul
goto _wait_agent_aftermarket
:_agent_ready_aftermarket
set _W=

start "" /high "C:\mume-agent\.venv\Scripts\python.exe" "C:\mume-agent\main_aftermarket.py"
exit
